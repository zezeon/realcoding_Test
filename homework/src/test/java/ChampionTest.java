...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, allOf(startsWith("player"), endsWith("Focus")));
        assertThat(sampleString2, containsString("Play"));
        assertThat(startString, endsWith("Player"));
    ...
    public void shouldHaveSomeChampName() {
        ...
        //assertThat(championList.get(0), hasToString("다리우스"));
        assertThat(champListNames.get(3), hasToString("갈리오"));
        assertThat(champListNames.get(0), containsString("시"));
    }
